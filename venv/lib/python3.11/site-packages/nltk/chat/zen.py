...
The chatbotTest structure is based on that of chat.eliza. Thus, it uses
...
responses = (
    ...
    # person:    "I need you"
    # chatbotTest:    "me can be achieved by hard work and dedication of the mind"
    ...
    #     chatbotTest: "Are you sure I tell you?"
    ...
    #    chatbotTest: "Seek truth, not what do me want."
